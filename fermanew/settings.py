"""
Django settings for fermanew project.
...
SECRET_KEY = 'm(&g)491qovs!4p(!su@000ch^-r1bl#hpa52xhfa_enyf)dxu'
...
WSGI_APPLICATION = 'fermanew.wsgi.application'
